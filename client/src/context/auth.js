...
export function AuthProvider({ children }) {
    ...
    const Accounts = async (userId) => {
        try {
            ...
            const response = await axios.get(`https://localhost:4000/PaySa/Account/getByUserId`, {
                params: { userId },
            });
    ...
    const fetchAccountDataTransaction = async (accountId) => {
        ...
        try {
            ...
            const response = await axios.get(
                `https://localhost:4000/PaySa/Transaction/getTransactionsForAccount?accountId=${accountId}`
            );
    ...
    async function fetchTransactionSummary(accountId) {
        try {
            const response = await axios.get(`https://localhost:4000/PaySa/Transaction/getTransactionSummary?accountId=${accountId}`);
    ...
    async function AllUsers() {
        try {
            const response = await axios.get("https://localhost:4000/PaySa/User/allUser")
    ...
    async function AllTransaction() {
        try {
            const response = await axios.get("https://localhost:4000/PaySa/Transaction/allTransaction")
